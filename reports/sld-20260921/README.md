...
## GABLS1 128³ resolution study — 24 September 2026

[Read the audited three-grid comparison](surface_layer/gabls1/n128/results.md) · [Five-page illustrated chapter](surface_layer/gabls1/n128/results_section.pdf) · [Compact exports and audits](surface_layer/gabls1/n128/export/). Three matched 128³ nine-hour cases completed and passed source, paired-initial-state, native-height, exact-time, finite-field, wall-filter, surface-flux, reconstructed-transport and local-stability audits. The 128³ γ=2 one-face case has 8–9 h common-height shear 0.09080/0.04759/0.03967 s⁻¹ at 12.5/25/37.5 m; the two-face case has 0.09242/0.04739/0.04083. The fixed 1 m LES median is 0.10038/0.06666/0.05607. Peak resolved w² continues to change with grid, and 128³ SLD supports only the first 3.125 or 6.25 m. Thus the 32³–64³–128³ trend does not establish convergence or a fixed 12.5 m support comparison. The master report is now 119 pages and retains all previous DYCOMS/GABLS/SLD chapters.
