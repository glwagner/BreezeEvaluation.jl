...
factor3section=joinpath(D,"../resolved_factor3/factor_results_section.pdf")
isfile(factor3section) && push!(pages,factor3section)
...
factor3md=joinpath(D,"../resolved_factor3/results.md")
if isfile(factor3md)
 md*="\n\n---\n\n"*replace(read(factor3md,String),r"\]\((?!https?://)([^)]+)\)"=>s"](../resolved_factor3/\1)")
end
