...
pages=textpages("SurfaceLayerDiffusivity: first results",paragraphs,"sld_results",joinpath(D,"../../../work/sld/brief");footer="GABLS1 | Julia analysis | Four matched cases + historical Smagorinsky")
append!(pages,[joinpath(D,"figures/sld_physical_response.pdf"),joinpath(D,"figures/sld_exchange_and_skewness.pdf"),joinpath(D,"figures/sld_smagorinsky_variance.pdf")])
