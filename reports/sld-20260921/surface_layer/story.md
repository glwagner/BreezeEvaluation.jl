...
The preliminary comparison puts mean wind and temperature beside w² and w³, with surface exchange, resolved energy and skewness on a second page. A fourth figure now shows corrected resolved, SGS and total transport at native near-wall faces. Each figure states its window, grid and sample definition. Reference gaps remain explicit. Skewness is omitted where variance is too small for a meaningful normalized third moment.
