...
push!(intro,"Part IV presents SurfaceLayerDiffusivity: the mechanism, measured synthetic arithmetic evidence, and the controlled comparisons needed to assess physical fidelity. No completed SLD LES comparison is claimed in this edition.")
...
sldstory=joinpath(ROOT,"surface_layer","surface_layer_story.pdf")
isfile(sldstory) && push!(allpages,sldstory)
...
md*="\n\n---\n\n# Part III: GABLS3\n\n"*g3md
if isfile(sldstory)
 sldmd=read(joinpath(ROOT,"surface_layer","story.md"),String)
 sldmd=replace(sldmd,r"\]\((?!https?://)([^)]+)\)"=>s"](surface_layer/\1)")
