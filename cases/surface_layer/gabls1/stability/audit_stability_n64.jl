# Independent audit of local SLD stability state at 64³, including face two when active.
...
const λ, βᵐ, βʰ, z₁ = 2.0, 4.8, 7.8, 6.25
const minimum_stress, heat_guard = 1e-8, 1e-8  # (1e-4 m/s)², ρθ guard of the case
interior_xy(a) = size(a, 1) == 64 ? a[:, :, 1] : a[6:69, 6:69, 1]
